...
Take:
- Take `rasa-for-botfront` image version in `.botfront/botfront.yaml`. In the following it would be `v1.5.1-bf.3` (with the `v`)
...
images:
  default:
    ...
    rasa: botfront/rasa-for-botfront:v1.5.1-bf.3
