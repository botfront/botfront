            ...
            <React.Fragment>
                ...
                <Header as='h1' className='logo'>
                    <div className='image-container'>
                        <Image src={settingsReady ? settings.settings.public.logoUrl : ''} centered />
                    </div>
                </Header>
                <Header as='h1' className='simple-logo'>
                    <div className='image-container-simple'>
                        <Image src={settingsReady ? settings.settings.public.logoUrl : ''} />
                    </div>
                </Header>
...
const ProjectSidebarContainer = withTracker((props) => {
    ...
    const settings = GlobalSettings.findOne({}, { fields: { 'settings.public.docUrl': 1, 'settings.public.intercomAppId': 1, 'settings.public.logoUrl': 1 } });
