...
class ProjectInfo extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                {ready && (
                    <AutoForm schema={projectsSchema || projectsSchemaDefault} model={project} onSubmit={updateProject => this.onSave(updateProject, modelLanguages)} disabled={!!saving || hasProjectWritePermission}>
