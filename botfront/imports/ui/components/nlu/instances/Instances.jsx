...
class Instances extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                {ready && (
                    <AutoForm schema={InstanceSchema} model={instance} onSubmit={updatedInstance => this.onSave(updatedInstance)} onValidate={this.onValidate} disabled={hasProjectWritePermission}>
