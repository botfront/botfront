...
const StoryEditorContainer = ({
    ...
    const {
        stories, forms, getResponseLocations, reloadStories,
    ...
    function onDestinationStorySelection(event, { value }) {
        if (value === '') {
            ...
            Meteor.call('stories.removeCheckpoints', projectId, destinationStory._id, branchPath, () => Meteor.call(
                'stories.addCheckpoints', projectId, value, branchPath,
            ));
        } else {
    ...
    const renderTopMenu = () => (
        <StoryTopMenu
            ...
            isUnpublished={story.status === 'unpublished'}
        />
    );
