...
const test_project = {
    "_id": "test",
    'namespace': 'bf-test',
    "name": "My Project", "defaultLanguage": "en", "defaultDomain": { "content": "slots:\n  disambiguation_message:\n    type: unfeaturized\nactions:\n  - action_botfront_disambiguation\n  - action_botfront_disambiguation_followup\n  - action_botfront_fallback\n  - action_botfront_mapping" }, "enableSharing": false, "disabled": false, "nlu_models": ["test_model"], "updatedAt": { "$date": "2020-07-24T13:51:26.698Z" }, "storyGroups": ["r4xYPj8w6MgkwjQTm"], "training": { "instanceStatus": "notTraining" }
}
