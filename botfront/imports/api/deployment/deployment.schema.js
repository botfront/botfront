...
export const DeploymentSchema = new SimpleSchema({
    ...
    'deployment.config.nlu_models_bucket': { type: String, regEx: /^[a-z0-9-_]+$/, optional: true },
    'deployment.config.core_models_bucket': { type: String, regEx: /^[a-z0-9-_]+$/, optional: true },
