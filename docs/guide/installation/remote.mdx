...
1. 8000 for duclking
2. 5055 for rasa action server
3. 5005 for rasa server
4. 8888 for botfront ui
5. 27017 for mongoDB
</Important>
3. Install Node.js
...
```
<Important type="tip" title="optional">

Go to `settings` and replace the urls with the urls on credentials, instance and endpoint to your host.(optional)
</Important>
