...
look up the id of your project, in this example url `http://123.99.135.3:8888/project/mSvL3ccZaz5RimDpF/incoming`, `mSvL3ccZaz5RimDpF` is the project id.

Then run `botfront set-project <project_id>`, rasa will restart and fetch this project's configuration.
