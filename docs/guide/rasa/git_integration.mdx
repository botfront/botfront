...
Your key will then be created.

Add Your new SSH key as an authentication method for the repo you are going to use for your botfront project.
It is highly recomended that you limit the access of this key to the minimum permissions required to pull and push to the branch you are using for your project.
...
There are many ways to authenticate a git repository. In this section we will be focusing on the two main ones, username password, and SSH keys
