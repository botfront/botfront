...
To add an image, simply select the image type. If you're using Botfront locally, you must add the link to your image. If you deployed Botfront on the cloud you'll need to have setup the webhooks for images, the webhooks docs is [here](/docs/installation/integration/)
