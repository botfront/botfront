...
This will allow your bot to know how the form ended. More details [over here](http://localhost:8001/docs/rasa/forms-slot-filling/#after-setting-a-slot).
...
To react to a particular exit from a form, [you can set a slot](http://localhost:8001/docs/rasa/forms-slot-filling/#explicitely-setting-a-slot) at one of the ends of your form.
